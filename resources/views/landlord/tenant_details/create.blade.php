    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="panel-body">
                <div class="row">
                    <div>
                        {!! Form::label('tenant_id', trans('Tenant_Id').'*', ['class' => 'control-label']) !!}
                        {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => '']) !!}
                        {{-- {!! Form::select('property_id', $properties, old('property_id'), ['class' => 'form-control select2', 'required' => '']) !!} --}}
                        {{-- <p class="help-block"></p>
                        @if($errors->has('property_id'))
            ...
            <div class="panel-body">
                <div class="row">
                    <div>
                        {!! Form::label('property_id', trans('Property_Name').'*', ['class' => 'control-label']) !!}
                        {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => '']) !!}
                        {{-- {!! Form::select('property_id', $properties, old('property_id'), ['class' => 'form-control select2', 'required' => '']) !!} --}}
                        <p class="help-block"></p>
                        {{-- @if($errors->has('property_id'))
                ...
                <div class="panel-body">
                    <div class="row">
                        <div>
                            {!! Form::label('tenant_id', trans('Tenant_Name').'*', ['class' => 'control-label']) !!}
                            {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            {{-- {!! Form::select('property_id', $properties, old('property_id'), ['class' => 'form-control select2', 'required' => '']) !!} --}}
                            {{-- <p class="help-block"></p>
                            @if($errors->has('property_id'))
                ...
                <div class="panel-body">
                    <div class="row">
                        <div>
                            {!! Form::label('property_id', trans('Family Member Count').'*', ['class' => 'control-label']) !!}
                            {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            {{-- {!! Form::select('property_id', $properties, old('property_id'), ['class' => 'form-control select2', 'required' => '']) !!} --}}
                            {{-- <p class="help-block"></p>
                            @if($errors->has('property_id'))
                ...
                <div class="panel-body">
                    <div class="row">
                        <div>
                            {!! Form::label('property_id', trans('Payment').'*', ['class' => 'control-label']) !!}
                            {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => '']) !!}
                            {{-- {!! Form::select('property_id', $properties, old('property_id'), ['class' => 'form-control select2', 'required' => '']) !!} --}}
                            {{-- <p class="help-block"></p>
                            @if($errors->has('property_id'))
