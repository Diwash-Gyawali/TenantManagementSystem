...
@section('content')
    <h3 class="page-title">@lang('Tenant Details')</h3>

    <p>
        <a href="{{ route('landlord.tenant_details.create') }}" class="btn btn-success">@lang('Add Tenant')</a>
        
    </p>

    <p>
        <ul class="list-inline">
            <li><a href="{{ route('tenant_index') }}" style="{{ request('show_deleted') == 1 ? '' : 'font-weight: 700' }}">@lang('View All')</a></li> |
            <li><a href="{{ route('tenant_index') }}?show_deleted=1" style="{{ request('show_deleted') == 1 ? 'font-weight: 700' : '' }}">@lang('View Trash')</a></li>
        </ul>
    </p>
            ...
            <table class="table table-bordered table-striped  @can('note_delete') @if ( request('show_deleted') != 1 ) dt-select @endif @endcan">
                <thead>
                    <tr>
                        ...
                        <th>@lang('Family Members Count')</th>
